      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card mb-6 sm:mb-8 animate-fade-in-up">
            ...
            <span className="text-xs sm:text-sm font-medium">AI-Powered Digital Safety</span>
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-bold mb-4 sm:mb-6 animate-fade-in-up stagger-1">
          ...
          {/* Subheading */}
          <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 sm:mb-10 animate-fade-in-up stagger-2 text-balance px-4">
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-10 sm:mb-12 animate-fade-in-up stagger-3 px-4">
            <Button variant="hero" size="lg" className="w-full sm:w-auto group" onClick={() => scrollToSection("demo")}>
              Start Scanning Messages
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </Button>
            <Button variant="hero-outline" size="lg" className="w-full sm:w-auto" onClick={() => scrollToSection("features")}>
              Learn Safety Tips
            </Button>
          </div>
          ...
          {/* Trust Indicators */}
          <div className="mt-12 sm:mt-16 pt-6 sm:pt-8 border-t border-border/30 animate-fade-in-up stagger-4">
            <p className="text-xs sm:text-sm text-muted-foreground mb-4 sm:mb-6">Powered by advanced AI technology</p>
            <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-8">
              ...
              <div className="flex items-center gap-2 text-muted-foreground">
                <Zap className="w-4 h-4 sm:w-5 sm:h-5 text-amber" />
                <span className="text-xs sm:text-sm font-medium">Real-Time Analysis</span>
              </div>
              <div className="flex items-center gap-2 text-muted-foreground">
                <Sparkles className="w-4 h-4 sm:w-5 sm:h-5 text-violet" />
                <span className="text-xs sm:text-sm font-medium">Google AI Powered</span>
              </div>
            </div>
          </div>
        </div>
