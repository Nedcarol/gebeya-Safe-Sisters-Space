...
const Activism = () => {
  return (
    <section id="activism" className="py-24 relative overflow-hidden">
      {/* Background */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card mb-6">
              ...
              <span className="text-sm font-semibold">November 25 - December 10</span>
            </div>
            ...
            <div className="space-y-4 mb-8">
              {impactPoints.map((point, index) => (
                <div key={index} className="flex items-start gap-4 group">
                  <div className="w-10 h-10 rounded-xl gradient-bg flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
          ...
          <div className="relative">
            ...
            <div className="glass-card rounded-3xl p-8 lg:p-10 relative">
              ...
              <div className="flex items-center gap-3 mb-8">
                ...
                <h3 className="font-display font-bold text-xl">The Impact</h3>
              </div>
                ...
                {stats.map((stat, index) => (
                  <div key={index} className="relative">
                    ...
                    {index < stats.length - 1 && (
                      <div className="absolute -bottom-3 left-0 right-0 h-px bg-gradient-to-r from-border via-border/50 to-transparent" />
                    )}
                  </div>
                ))}
              </div>
